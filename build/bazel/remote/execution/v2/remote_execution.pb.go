...
func (DigestFunction_Value) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_c43847ba40caac95, []int{46, 0}
}
...
func (SymlinkAbsolutePathStrategy_Value) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_c43847ba40caac95, []int{49, 0}
}
...
type Action struct {
	...
	InputFileIds         []int32            `protobuf:"varint,9,rep,packed,name=input_file_ids,json=inputFileIds,proto3" json:"input_file_ids,omitempty"`
...
func (m *Action) GetInputFileIds() []int32 {
	if m != nil {
		return m.InputFileIds
	}
	return nil
}

type ActionGraph struct {
	InputRootMetadata     *Digest   `protobuf:"bytes,1,opt,name=input_root_metadata,json=inputRootMetadata,proto3" json:"input_root_metadata,omitempty"`
	ActionMetadataDigests []*Digest `protobuf:"bytes,2,rep,name=action_metadata_digests,json=actionMetadataDigests,proto3" json:"action_metadata_digests,omitempty"`
	XXX_NoUnkeyedLiteral  struct{}  `json:"-"`
	XXX_unrecognized      []byte    `json:"-"`
	XXX_sizecache         int32     `json:"-"`
}

func (m *ActionGraph) Reset()         { *m = ActionGraph{} }
func (m *ActionGraph) String() string { return proto.CompactTextString(m) }
func (*ActionGraph) ProtoMessage()    {}
func (*ActionGraph) Descriptor() ([]byte, []int) {
	return fileDescriptor_c43847ba40caac95, []int{1}
}

func (m *ActionGraph) XXX_Unmarshal(b []byte) error {
	return xxx_messageInfo_ActionGraph.Unmarshal(m, b)
}
func (m *ActionGraph) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	return xxx_messageInfo_ActionGraph.Marshal(b, m, deterministic)
}
func (m *ActionGraph) XXX_Merge(src proto.Message) {
	xxx_messageInfo_ActionGraph.Merge(m, src)
}
func (m *ActionGraph) XXX_Size() int {
	return xxx_messageInfo_ActionGraph.Size(m)
}
func (m *ActionGraph) XXX_DiscardUnknown() {
	xxx_messageInfo_ActionGraph.DiscardUnknown(m)
}

var xxx_messageInfo_ActionGraph proto.InternalMessageInfo

func (m *ActionGraph) GetInputRootMetadata() *Digest {
	if m != nil {
		return m.InputRootMetadata
	}
	return nil
}

func (m *ActionGraph) GetActionMetadataDigests() []*Digest {
	if m != nil {
		return m.ActionMetadataDigests
	}
	return nil
}
...
func (m *FileNodeData) Reset()         { *m = FileNodeData{} }
func (m *FileNodeData) String() string { return proto.CompactTextString(m) }
func (*FileNodeData) ProtoMessage()    {}
func (*FileNodeData) Descriptor() ([]byte, []int) {
	return fileDescriptor_c43847ba40caac95, []int{2}
}

func (m *FileNodeData) XXX_Unmarshal(b []byte) error {
	return xxx_messageInfo_FileNodeData.Unmarshal(m, b)
}
func (m *FileNodeData) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	return xxx_messageInfo_FileNodeData.Marshal(b, m, deterministic)
}
func (m *FileNodeData) XXX_Merge(src proto.Message) {
	xxx_messageInfo_FileNodeData.Merge(m, src)
}
func (m *FileNodeData) XXX_Size() int {
	return xxx_messageInfo_FileNodeData.Size(m)
}
func (m *FileNodeData) XXX_DiscardUnknown() {
	xxx_messageInfo_FileNodeData.DiscardUnknown(m)
}

var xxx_messageInfo_FileNodeData proto.InternalMessageInfo

func (m *FileNodeData) GetFileId() int32 {
	if m != nil {
		return m.FileId
	}
	return 0
...
func (m *FileNodeData) GetPath() string {
	if m != nil {
		return m.Path
	}
	return ""
...
func (m *FileNodeData) GetDigest() *Digest {
	if m != nil {
		return m.Digest
	}
	return nil
...
func (m *FileNodeData) GetIsExecutable() bool {
	if m != nil {
...
func (m *FileNodeData) GetNodeProperties() []*NodeProperty {
	if m != nil {
...
type GraphData struct {
	FileNodeData         []*FileNodeData `protobuf:"bytes,1,rep,name=file_node_data,json=fileNodeData,proto3" json:"file_node_data,omitempty"`
	XXX_NoUnkeyedLiteral struct{}        `json:"-"`
	XXX_unrecognized     []byte          `json:"-"`
	XXX_sizecache        int32           `json:"-"`
}
...
func (m *GraphData) GetFileNodeData() []*FileNodeData {
	if m != nil {
		return m.FileNodeData
	}
	return nil
}
...
func (*Command_EnvironmentVariable) Descriptor() ([]byte, []int) {
	return fileDescriptor_c43847ba40caac95, []int{4, 0}
}
...
func (*Platform_Property) Descriptor() ([]byte, []int) {
	return fileDescriptor_c43847ba40caac95, []int{5, 0}
}
...
type FindMissingGraphInputsRequest struct {
	GraphDataDigest      *Digest  `protobuf:"bytes,1,opt,name=graph_data_digest,json=graphDataDigest,proto3" json:"graph_data_digest,omitempty"`
	XXX_NoUnkeyedLiteral struct{} `json:"-"`
	XXX_unrecognized     []byte   `json:"-"`
	XXX_sizecache        int32    `json:"-"`
}

func (m *FindMissingGraphInputsRequest) Reset()         { *m = FindMissingGraphInputsRequest{} }
func (m *FindMissingGraphInputsRequest) String() string { return proto.CompactTextString(m) }
func (*FindMissingGraphInputsRequest) ProtoMessage()    {}
func (*FindMissingGraphInputsRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_c43847ba40caac95, []int{20}
}

func (m *FindMissingGraphInputsRequest) XXX_Unmarshal(b []byte) error {
	return xxx_messageInfo_FindMissingGraphInputsRequest.Unmarshal(m, b)
}
func (m *FindMissingGraphInputsRequest) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	return xxx_messageInfo_FindMissingGraphInputsRequest.Marshal(b, m, deterministic)
}
func (m *FindMissingGraphInputsRequest) XXX_Merge(src proto.Message) {
	xxx_messageInfo_FindMissingGraphInputsRequest.Merge(m, src)
}
func (m *FindMissingGraphInputsRequest) XXX_Size() int {
	return xxx_messageInfo_FindMissingGraphInputsRequest.Size(m)
}
func (m *FindMissingGraphInputsRequest) XXX_DiscardUnknown() {
	xxx_messageInfo_FindMissingGraphInputsRequest.DiscardUnknown(m)
}

var xxx_messageInfo_FindMissingGraphInputsRequest proto.InternalMessageInfo

func (m *FindMissingGraphInputsRequest) GetGraphDataDigest() *Digest {
	if m != nil {
		return m.GraphDataDigest
	}
	return nil
}

type GraphExecution struct {
	GraphDigest                *Digest                    `protobuf:"bytes,1,opt,name=graph_digest,json=graphDigest,proto3" json:"graph_digest,omitempty"`
	GraphDataDigest            *Digest                    `protobuf:"bytes,2,opt,name=graph_data_digest,json=graphDataDigest,proto3" json:"graph_data_digest,omitempty"`
	ActionCachingOptions       *GraphActionCachingOptions `protobuf:"bytes,3,opt,name=action_caching_options,json=actionCachingOptions,proto3" json:"action_caching_options,omitempty"`
	ActionCachingOptionsDigest *Digest                    `protobuf:"bytes,4,opt,name=action_caching_options_digest,json=actionCachingOptionsDigest,proto3" json:"action_caching_options_digest,omitempty"`
	OutputOptions              *GraphOutputOptions        `protobuf:"bytes,5,opt,name=output_options,json=outputOptions,proto3" json:"output_options,omitempty"`
	OutputOptionsDigest        *Digest                    `protobuf:"bytes,6,opt,name=output_options_digest,json=outputOptionsDigest,proto3" json:"output_options_digest,omitempty"`
	XXX_NoUnkeyedLiteral       struct{}                   `json:"-"`
	XXX_unrecognized           []byte                     `json:"-"`
	XXX_sizecache              int32                      `json:"-"`
}

func (m *GraphExecution) Reset()         { *m = GraphExecution{} }
func (m *GraphExecution) String() string { return proto.CompactTextString(m) }
func (*GraphExecution) ProtoMessage()    {}
func (*GraphExecution) Descriptor() ([]byte, []int) {
	return fileDescriptor_c43847ba40caac95, []int{21}
}

func (m *GraphExecution) XXX_Unmarshal(b []byte) error {
	return xxx_messageInfo_GraphExecution.Unmarshal(m, b)
}
func (m *GraphExecution) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	return xxx_messageInfo_GraphExecution.Marshal(b, m, deterministic)
}
func (m *GraphExecution) XXX_Merge(src proto.Message) {
	xxx_messageInfo_GraphExecution.Merge(m, src)
}
func (m *GraphExecution) XXX_Size() int {
	return xxx_messageInfo_GraphExecution.Size(m)
}
func (m *GraphExecution) XXX_DiscardUnknown() {
	xxx_messageInfo_GraphExecution.DiscardUnknown(m)
}

var xxx_messageInfo_GraphExecution proto.InternalMessageInfo

func (m *GraphExecution) GetGraphDigest() *Digest {
	if m != nil {
		return m.GraphDigest
	}
	return nil
}

func (m *GraphExecution) GetGraphDataDigest() *Digest {
	if m != nil {
		return m.GraphDataDigest
	}
	return nil
...
func (m *GraphExecution) GetActionCachingOptions() *GraphActionCachingOptions {
	if m != nil {
		return m.ActionCachingOptions
	}
	return nil
}

func (m *GraphExecution) GetActionCachingOptionsDigest() *Digest {
	if m != nil {
		return m.ActionCachingOptionsDigest
	}
	return nil
}

func (m *GraphExecution) GetOutputOptions() *GraphOutputOptions {
	if m != nil {
		return m.OutputOptions
	}
	return nil
}

func (m *GraphExecution) GetOutputOptionsDigest() *Digest {
	if m != nil {
		return m.OutputOptionsDigest
	}
	return nil
}
...
func (m *ExecutionToken) Reset()         { *m = ExecutionToken{} }
func (m *ExecutionToken) String() string { return proto.CompactTextString(m) }
func (*ExecutionToken) ProtoMessage()    {}
func (*ExecutionToken) Descriptor() ([]byte, []int) {
	return fileDescriptor_c43847ba40caac95, []int{22}
}

func (m *ExecutionToken) XXX_Unmarshal(b []byte) error {
	return xxx_messageInfo_ExecutionToken.Unmarshal(m, b)
}
func (m *ExecutionToken) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	return xxx_messageInfo_ExecutionToken.Marshal(b, m, deterministic)
}
func (m *ExecutionToken) XXX_Merge(src proto.Message) {
	xxx_messageInfo_ExecutionToken.Merge(m, src)
}
func (m *ExecutionToken) XXX_Size() int {
	return xxx_messageInfo_ExecutionToken.Size(m)
}
func (m *ExecutionToken) XXX_DiscardUnknown() {
	xxx_messageInfo_ExecutionToken.DiscardUnknown(m)
}

var xxx_messageInfo_ExecutionToken proto.InternalMessageInfo

func (m *ExecutionToken) GetName() string {
	if m != nil {
		return m.Name
	}
	return ""
...
func (m *ExecutionToken) GetPageToken() string {
	if m != nil {
		return m.PageToken
	}
	return ""
...
type ExecuteGraphRequest struct {
	GraphExecution       *GraphExecution `protobuf:"bytes,1,opt,name=graph_execution,json=graphExecution,proto3" json:"graph_execution,omitempty"`
	ExecutionToken       *ExecutionToken `protobuf:"bytes,2,opt,name=execution_token,json=executionToken,proto3" json:"execution_token,omitempty"`
	UploadedInput        []*Digest       `protobuf:"bytes,3,rep,name=uploaded_input,json=uploadedInput,proto3" json:"uploaded_input,omitempty"`
	XXX_NoUnkeyedLiteral struct{}        `json:"-"`
	XXX_unrecognized     []byte          `json:"-"`
	XXX_sizecache        int32           `json:"-"`
}
...
func (m *ExecuteGraphRequest) GetGraphExecution() *GraphExecution {
	if m != nil {
		return m.GraphExecution
	}
	return nil
}

func (m *ExecuteGraphRequest) GetExecutionToken() *ExecutionToken {
	if m != nil {
...
func (m *ExecuteGraphRequest) GetUploadedInput() []*Digest {
	if m != nil {
		return m.UploadedInput
	}
	return nil
}

type GraphExecutionProgress struct {
	ActionCacheHits      int32    `protobuf:"varint,1,opt,name=action_cache_hits,json=actionCacheHits,proto3" json:"action_cache_hits,omitempty"`
	CompletedExecutions  int32    `protobuf:"varint,2,opt,name=completed_executions,json=completedExecutions,proto3" json:"completed_executions,omitempty"`
	ExecutionsInProgress int32    `protobuf:"varint,3,opt,name=executions_in_progress,json=executionsInProgress,proto3" json:"executions_in_progress,omitempty"`
	WaitingOnInputs      int32    `protobuf:"varint,4,opt,name=waiting_on_inputs,json=waitingOnInputs,proto3" json:"waiting_on_inputs,omitempty"`
	MissingInputs        int32    `protobuf:"varint,5,opt,name=missing_inputs,json=missingInputs,proto3" json:"missing_inputs,omitempty"`
	XXX_NoUnkeyedLiteral struct{} `json:"-"`
	XXX_unrecognized     []byte   `json:"-"`
	XXX_sizecache        int32    `json:"-"`
}

func (m *GraphExecutionProgress) Reset()         { *m = GraphExecutionProgress{} }
func (m *GraphExecutionProgress) String() string { return proto.CompactTextString(m) }
func (*GraphExecutionProgress) ProtoMessage()    {}
func (*GraphExecutionProgress) Descriptor() ([]byte, []int) {
	return fileDescriptor_c43847ba40caac95, []int{24}
}

func (m *GraphExecutionProgress) XXX_Unmarshal(b []byte) error {
	return xxx_messageInfo_GraphExecutionProgress.Unmarshal(m, b)
}
func (m *GraphExecutionProgress) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	return xxx_messageInfo_GraphExecutionProgress.Marshal(b, m, deterministic)
}
func (m *GraphExecutionProgress) XXX_Merge(src proto.Message) {
	xxx_messageInfo_GraphExecutionProgress.Merge(m, src)
}
func (m *GraphExecutionProgress) XXX_Size() int {
	return xxx_messageInfo_GraphExecutionProgress.Size(m)
}
func (m *GraphExecutionProgress) XXX_DiscardUnknown() {
	xxx_messageInfo_GraphExecutionProgress.DiscardUnknown(m)
}

var xxx_messageInfo_GraphExecutionProgress proto.InternalMessageInfo

func (m *GraphExecutionProgress) GetActionCacheHits() int32 {
	if m != nil {
		return m.ActionCacheHits
	}
	return 0
}

func (m *GraphExecutionProgress) GetCompletedExecutions() int32 {
	if m != nil {
...
func (m *GraphExecutionProgress) GetExecutionsInProgress() int32 {
	if m != nil {
		return m.ExecutionsInProgress
	}
	return 0
}

func (m *GraphExecutionProgress) GetWaitingOnInputs() int32 {
	if m != nil {
		return m.WaitingOnInputs
	}
	return 0
}

func (m *GraphExecutionProgress) GetMissingInputs() int32 {
	if m != nil {
		return m.MissingInputs
	}
	return 0
}

type ExecuteGraphResponse struct {
	ExecutionToken       *ExecutionToken         `protobuf:"bytes,1,opt,name=execution_token,json=executionToken,proto3" json:"execution_token,omitempty"`
	Progress             *GraphExecutionProgress `protobuf:"bytes,2,opt,name=progress,proto3" json:"progress,omitempty"`
	ActionResults        []*ActionResult         `protobuf:"bytes,3,rep,name=action_results,json=actionResults,proto3" json:"action_results,omitempty"`
	MissingInputs        []*Digest               `protobuf:"bytes,4,rep,name=missing_inputs,json=missingInputs,proto3" json:"missing_inputs,omitempty"`
	XXX_NoUnkeyedLiteral struct{}                `json:"-"`
	XXX_unrecognized     []byte                  `json:"-"`
	XXX_sizecache        int32                   `json:"-"`
}

func (m *ExecuteGraphResponse) Reset()         { *m = ExecuteGraphResponse{} }
func (m *ExecuteGraphResponse) String() string { return proto.CompactTextString(m) }
...
func (m *ExecuteGraphResponse) XXX_Unmarshal(b []byte) error {
	return xxx_messageInfo_ExecuteGraphResponse.Unmarshal(m, b)
}
func (m *ExecuteGraphResponse) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	return xxx_messageInfo_ExecuteGraphResponse.Marshal(b, m, deterministic)
}
func (m *ExecuteGraphResponse) XXX_Merge(src proto.Message) {
	xxx_messageInfo_ExecuteGraphResponse.Merge(m, src)
}
func (m *ExecuteGraphResponse) XXX_Size() int {
	return xxx_messageInfo_ExecuteGraphResponse.Size(m)
}
func (m *ExecuteGraphResponse) XXX_DiscardUnknown() {
	xxx_messageInfo_ExecuteGraphResponse.DiscardUnknown(m)
}

var xxx_messageInfo_ExecuteGraphResponse proto.InternalMessageInfo

func (m *ExecuteGraphResponse) GetExecutionToken() *ExecutionToken {
	if m != nil {
		return m.ExecutionToken
	}
	return nil
...
func (m *ExecuteGraphResponse) GetProgress() *GraphExecutionProgress {
	if m != nil {
		return m.Progress
	}
	return nil
...
func (m *ExecuteGraphResponse) GetActionResults() []*ActionResult {
	if m != nil {
...
func (m *ExecuteGraphResponse) GetMissingInputs() []*Digest {
	if m != nil {
		return m.MissingInputs
	}
	return nil
...
type GraphActionCachingOptions struct {
	ReexecuteAll         bool      `protobuf:"varint,1,opt,name=reexecute_all,json=reexecuteAll,proto3" json:"reexecute_all,omitempty"`
	ReexecuteActions     []*Digest `protobuf:"bytes,2,rep,name=reexecute_actions,json=reexecuteActions,proto3" json:"reexecute_actions,omitempty"`
	XXX_NoUnkeyedLiteral struct{}  `json:"-"`
	XXX_unrecognized     []byte    `json:"-"`
	XXX_sizecache        int32     `json:"-"`
}

func (m *GraphActionCachingOptions) Reset()         { *m = GraphActionCachingOptions{} }
func (m *GraphActionCachingOptions) String() string { return proto.CompactTextString(m) }
func (*GraphActionCachingOptions) ProtoMessage()    {}
func (*GraphActionCachingOptions) Descriptor() ([]byte, []int) {
	return fileDescriptor_c43847ba40caac95, []int{26}
}

func (m *GraphActionCachingOptions) XXX_Unmarshal(b []byte) error {
	return xxx_messageInfo_GraphActionCachingOptions.Unmarshal(m, b)
}
func (m *GraphActionCachingOptions) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	return xxx_messageInfo_GraphActionCachingOptions.Marshal(b, m, deterministic)
}
func (m *GraphActionCachingOptions) XXX_Merge(src proto.Message) {
	xxx_messageInfo_GraphActionCachingOptions.Merge(m, src)
}
func (m *GraphActionCachingOptions) XXX_Size() int {
	return xxx_messageInfo_GraphActionCachingOptions.Size(m)
}
func (m *GraphActionCachingOptions) XXX_DiscardUnknown() {
	xxx_messageInfo_GraphActionCachingOptions.DiscardUnknown(m)
}

var xxx_messageInfo_GraphActionCachingOptions proto.InternalMessageInfo

func (m *GraphActionCachingOptions) GetReexecuteAll() bool {
	if m != nil {
		return m.ReexecuteAll
	}
	return false
}

func (m *GraphActionCachingOptions) GetReexecuteActions() []*Digest {
	if m != nil {
		return m.ReexecuteActions
	}
	return nil
}

type GraphOutputOptions struct {
	StreamAllIndividualResults bool     `protobuf:"varint,1,opt,name=stream_all_individual_results,json=streamAllIndividualResults,proto3" json:"stream_all_individual_results,omitempty"`
	OutputFileIds              []int32  `protobuf:"varint,2,rep,packed,name=output_file_ids,json=outputFileIds,proto3" json:"output_file_ids,omitempty"`
	StreamExecutedStdout       bool     `protobuf:"varint,3,opt,name=stream_executed_stdout,json=streamExecutedStdout,proto3" json:"stream_executed_stdout,omitempty"`
	StreamAllStdout            bool     `protobuf:"varint,4,opt,name=stream_all_stdout,json=streamAllStdout,proto3" json:"stream_all_stdout,omitempty"`
	StreamExecutedStderr       bool     `protobuf:"varint,5,opt,name=stream_executed_stderr,json=streamExecutedStderr,proto3" json:"stream_executed_stderr,omitempty"`
	StreamAllStderr            bool     `protobuf:"varint,6,opt,name=stream_all_stderr,json=streamAllStderr,proto3" json:"stream_all_stderr,omitempty"`
	XXX_NoUnkeyedLiteral       struct{} `json:"-"`
	XXX_unrecognized           []byte   `json:"-"`
	XXX_sizecache              int32    `json:"-"`
}

func (m *GraphOutputOptions) Reset()         { *m = GraphOutputOptions{} }
func (m *GraphOutputOptions) String() string { return proto.CompactTextString(m) }
func (*GraphOutputOptions) ProtoMessage()    {}
func (*GraphOutputOptions) Descriptor() ([]byte, []int) {
	return fileDescriptor_c43847ba40caac95, []int{27}
}

func (m *GraphOutputOptions) XXX_Unmarshal(b []byte) error {
	return xxx_messageInfo_GraphOutputOptions.Unmarshal(m, b)
}
func (m *GraphOutputOptions) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	return xxx_messageInfo_GraphOutputOptions.Marshal(b, m, deterministic)
}
func (m *GraphOutputOptions) XXX_Merge(src proto.Message) {
	xxx_messageInfo_GraphOutputOptions.Merge(m, src)
}
func (m *GraphOutputOptions) XXX_Size() int {
	return xxx_messageInfo_GraphOutputOptions.Size(m)
}
func (m *GraphOutputOptions) XXX_DiscardUnknown() {
	xxx_messageInfo_GraphOutputOptions.DiscardUnknown(m)
}

var xxx_messageInfo_GraphOutputOptions proto.InternalMessageInfo

func (m *GraphOutputOptions) GetStreamAllIndividualResults() bool {
	if m != nil {
		return m.StreamAllIndividualResults
	}
	return false
}

func (m *GraphOutputOptions) GetOutputFileIds() []int32 {
	if m != nil {
		return m.OutputFileIds
	}
	return nil
}

func (m *GraphOutputOptions) GetStreamExecutedStdout() bool {
	if m != nil {
		return m.StreamExecutedStdout
	}
	return false
}

func (m *GraphOutputOptions) GetStreamAllStdout() bool {
	if m != nil {
		return m.StreamAllStdout
	}
	return false
}

func (m *GraphOutputOptions) GetStreamExecutedStderr() bool {
	if m != nil {
		return m.StreamExecutedStderr
	}
	return false
}

func (m *GraphOutputOptions) GetStreamAllStderr() bool {
	if m != nil {
		return m.StreamAllStderr
	}
	return false
}
...
func (*BatchReadBlobsResponse_Response) Descriptor() ([]byte, []int) {
	return fileDescriptor_c43847ba40caac95, []int{41, 0}
}
...
func (*ServerCapabilities) Descriptor() ([]byte, []int) {
	return fileDescriptor_c43847ba40caac95, []int{45}
}
...
func (*DigestFunction) Descriptor() ([]byte, []int) {
	return fileDescriptor_c43847ba40caac95, []int{46}
}
...
func (*ActionCacheUpdateCapabilities) Descriptor() ([]byte, []int) {
	return fileDescriptor_c43847ba40caac95, []int{47}
}
...
func (*PriorityCapabilities) Descriptor() ([]byte, []int) {
	return fileDescriptor_c43847ba40caac95, []int{48}
}
...
func (*PriorityCapabilities_PriorityRange) Descriptor() ([]byte, []int) {
	return fileDescriptor_c43847ba40caac95, []int{48, 0}
}
...
func (*SymlinkAbsolutePathStrategy) Descriptor() ([]byte, []int) {
	return fileDescriptor_c43847ba40caac95, []int{49}
}
...
func (*CacheCapabilities) Descriptor() ([]byte, []int) {
	return fileDescriptor_c43847ba40caac95, []int{50}
}
...
func (*ExecutionCapabilities) Descriptor() ([]byte, []int) {
	return fileDescriptor_c43847ba40caac95, []int{51}
}
...
func (*ToolDetails) Descriptor() ([]byte, []int) {
	return fileDescriptor_c43847ba40caac95, []int{52}
}
...
func (*RequestMetadata) Descriptor() ([]byte, []int) {
	return fileDescriptor_c43847ba40caac95, []int{53}
}
...
func init() {
	...
	proto.RegisterType((*ActionGraph)(nil), "build.bazel.remote.execution.v2.ActionGraph")
	proto.RegisterType((*FileNodeData)(nil), "build.bazel.remote.execution.v2.FileNodeData")
	proto.RegisterType((*GraphData)(nil), "build.bazel.remote.execution.v2.GraphData")
	...
	proto.RegisterType((*FindMissingGraphInputsRequest)(nil), "build.bazel.remote.execution.v2.FindMissingGraphInputsRequest")
	proto.RegisterType((*GraphExecution)(nil), "build.bazel.remote.execution.v2.GraphExecution")
	proto.RegisterType((*ExecutionToken)(nil), "build.bazel.remote.execution.v2.ExecutionToken")
	proto.RegisterType((*ExecuteGraphRequest)(nil), "build.bazel.remote.execution.v2.ExecuteGraphRequest")
	proto.RegisterType((*GraphExecutionProgress)(nil), "build.bazel.remote.execution.v2.GraphExecutionProgress")
	proto.RegisterType((*ExecuteGraphResponse)(nil), "build.bazel.remote.execution.v2.ExecuteGraphResponse")
	proto.RegisterType((*GraphActionCachingOptions)(nil), "build.bazel.remote.execution.v2.GraphActionCachingOptions")
	proto.RegisterType((*GraphOutputOptions)(nil), "build.bazel.remote.execution.v2.GraphOutputOptions")
...
var fileDescriptor_c43847ba40caac95 = []byte{
	...
	,
}
...
type ExecutionClient interface {
	...
	ExecuteGraph(ctx context.Context, opts ...grpc.CallOption) (Execution_ExecuteGraphClient, error)
}
...
func (c *executionClient) ExecuteGraph(ctx context.Context, opts ...grpc.CallOption) (Execution_ExecuteGraphClient, error) {
	stream, err := c.cc.NewStream(ctx, &_Execution_serviceDesc.Streams[2], "/build.bazel.remote.execution.v2.Execution/ExecuteGraph", opts...)
	if err != nil {
		return nil, err
	}
	x := &executionExecuteGraphClient{stream}
	return x, nil
}

type Execution_ExecuteGraphClient interface {
	Send(*ExecuteGraphRequest) error
	Recv() (*ExecuteGraphResponse, error)
	grpc.ClientStream
}

type executionExecuteGraphClient struct {
	grpc.ClientStream
}

func (x *executionExecuteGraphClient) Send(m *ExecuteGraphRequest) error {
	return x.ClientStream.SendMsg(m)
}

func (x *executionExecuteGraphClient) Recv() (*ExecuteGraphResponse, error) {
	m := new(ExecuteGraphResponse)
	if err := x.ClientStream.RecvMsg(m); err != nil {
		return nil, err
	}
	return m, nil
...
type ExecutionServer interface {
	...
	ExecuteGraph(Execution_ExecuteGraphServer) error
}
...
func (*UnimplementedExecutionServer) ExecuteGraph(srv Execution_ExecuteGraphServer) error {
	return status1.Errorf(codes.Unimplemented, "method ExecuteGraph not implemented")
}
...
func _Execution_ExecuteGraph_Handler(srv interface{}, stream grpc.ServerStream) error {
	return srv.(ExecutionServer).ExecuteGraph(&executionExecuteGraphServer{stream})
}

type Execution_ExecuteGraphServer interface {
	Send(*ExecuteGraphResponse) error
	Recv() (*ExecuteGraphRequest, error)
	grpc.ServerStream
}

type executionExecuteGraphServer struct {
	grpc.ServerStream
}

func (x *executionExecuteGraphServer) Send(m *ExecuteGraphResponse) error {
	return x.ServerStream.SendMsg(m)
}

func (x *executionExecuteGraphServer) Recv() (*ExecuteGraphRequest, error) {
	m := new(ExecuteGraphRequest)
...
var _Execution_serviceDesc = grpc.ServiceDesc{
	...
	Streams: []grpc.StreamDesc{
		...
		{
			StreamName:    "ExecuteGraph",
			Handler:       _Execution_ExecuteGraph_Handler,
			ServerStreams: true,
			ClientStreams: true,
		},
	},
...
type ContentAddressableStorageClient interface {
	...
	FindMissingGraphInputs(ctx context.Context, in *FindMissingGraphInputsRequest, opts ...grpc.CallOption) (ContentAddressableStorage_FindMissingGraphInputsClient, error)
...
func (c *contentAddressableStorageClient) FindMissingGraphInputs(ctx context.Context, in *FindMissingGraphInputsRequest, opts ...grpc.CallOption) (ContentAddressableStorage_FindMissingGraphInputsClient, error) {
	stream, err := c.cc.NewStream(ctx, &_ContentAddressableStorage_serviceDesc.Streams[0], "/build.bazel.remote.execution.v2.ContentAddressableStorage/FindMissingGraphInputs", opts...)
	if err != nil {
		return nil, err
	}
	x := &contentAddressableStorageFindMissingGraphInputsClient{stream}
	if err := x.ClientStream.SendMsg(in); err != nil {
		return nil, err
	}
	if err := x.ClientStream.CloseSend(); err != nil {
...
type ContentAddressableStorage_FindMissingGraphInputsClient interface {
	Recv() (*FindMissingBlobsResponse, error)
	grpc.ClientStream
}

type contentAddressableStorageFindMissingGraphInputsClient struct {
	grpc.ClientStream
}

func (x *contentAddressableStorageFindMissingGraphInputsClient) Recv() (*FindMissingBlobsResponse, error) {
	m := new(FindMissingBlobsResponse)
	if err := x.ClientStream.RecvMsg(m); err != nil {
		return nil, err
	}
	return m, nil
...
func (c *contentAddressableStorageClient) GetTree(ctx context.Context, in *GetTreeRequest, opts ...grpc.CallOption) (ContentAddressableStorage_GetTreeClient, error) {
	stream, err := c.cc.NewStream(ctx, &_ContentAddressableStorage_serviceDesc.Streams[1], "/build.bazel.remote.execution.v2.ContentAddressableStorage/GetTree", opts...)
	if err != nil {
		return nil, err
	}
...
type ContentAddressableStorageServer interface {
	...
	FindMissingGraphInputs(*FindMissingGraphInputsRequest, ContentAddressableStorage_FindMissingGraphInputsServer) error
...
func (*UnimplementedContentAddressableStorageServer) FindMissingGraphInputs(req *FindMissingGraphInputsRequest, srv ContentAddressableStorage_FindMissingGraphInputsServer) error {
	return status1.Errorf(codes.Unimplemented, "method FindMissingGraphInputs not implemented")
}
...
func _ContentAddressableStorage_FindMissingGraphInputs_Handler(srv interface{}, stream grpc.ServerStream) error {
	m := new(FindMissingGraphInputsRequest)
	if err := stream.RecvMsg(m); err != nil {
		return err
	}
	return srv.(ContentAddressableStorageServer).FindMissingGraphInputs(m, &contentAddressableStorageFindMissingGraphInputsServer{stream})
}

type ContentAddressableStorage_FindMissingGraphInputsServer interface {
	Send(*FindMissingBlobsResponse) error
	grpc.ServerStream
}

type contentAddressableStorageFindMissingGraphInputsServer struct {
	grpc.ServerStream
}

func (x *contentAddressableStorageFindMissingGraphInputsServer) Send(m *FindMissingBlobsResponse) error {
	return x.ServerStream.SendMsg(m)
}
...
var _ContentAddressableStorage_serviceDesc = grpc.ServiceDesc{
	...
	Streams: []grpc.StreamDesc{
		{
			StreamName:    "FindMissingGraphInputs",
			Handler:       _ContentAddressableStorage_FindMissingGraphInputs_Handler,
			ServerStreams: true,
		},
		{
			StreamName:    "GetTree",
